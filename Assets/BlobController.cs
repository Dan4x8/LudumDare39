...
public class BlobController : MonoBehaviour {
	public enum BlobOnClickBehaviour {Shrink,MoveBackwards, Split, None}
	...
	public BlobOnClickBehaviour Difficulty = BlobOnClickBehaviour.MoveBackwards;
	...
	public void OnMouseDown()
	{
		switch(Difficulty)
		{
		case BlobOnClickBehaviour.MoveBackwards:
